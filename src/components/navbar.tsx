...
const MAIN_LINKS = [
  { href: "https://aivideos.codelove.in", label: "Home" },
  { href: "https://aivideos.codelove.in/videos", label: "Browse" },
  { href: "https://aivideos.codelove.in/trending-ai-videos", label: "Trending" },
  { href: "https://aivideos.codelove.in/latest-ai-videos", label: "Latest" },
  { href: "/", label: "Bundles" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="hide-scrollbar -mt-0.5 flex gap-2 overflow-x-auto pb-2.5">
          {NAV_CATEGORIES.map((c) => {
            const href = `https://aivideos.codelove.in/${c.slug}`;
