      ...
      <div className="mx-auto max-w-7xl px-4 py-12 pb-28 md:pb-12 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="https://aivideos.codelove.in" className="flex items-center gap-2 font-bold">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-muted lg:block lg:space-y-2">
              {CATEGORIES.filter((c) => c.kind === "folder").slice(0, 4).map((c) => (
                <li key={c.slug}>
                  <a href={`https://aivideos.codelove.in/${c.slug}`} className="hover:text-brand-400">
                    {c.name}
                  </a>
                </li>
              ))}
              <li className="col-span-2 lg:col-span-1 mt-1">
                <a href="https://aivideos.codelove.in/categories" className="font-semibold text-brand-400 hover:text-brand-300 hover:underline inline-flex items-center gap-1">
                  All Categories
                </a>
              </li>
            </ul>
          ...
          <div className="col-span-1 grid grid-cols-2 gap-8 sm:col-span-2 lg:col-span-2">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted">
                <li><a href="https://aivideos.codelove.in/videos" className="hover:text-brand-400">Browse All</a></li>
                <li><a href="https://aivideos.codelove.in/trending-ai-videos" className="hover:text-brand-400">Trending</a></li>
                <li><a href="https://aivideos.codelove.in/latest-ai-videos" className="hover:text-brand-400">Latest</a></li>
                <li><a href="https://aivideos.codelove.in/popular-ai-videos" className="hover:text-brand-400">Popular</a></li>
                <li><a href="https://aivideos.codelove.in/categories" className="hover:text-brand-400">All Categories</a></li>
              </ul>
            </div>
